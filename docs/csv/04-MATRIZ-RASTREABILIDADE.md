...
| REQ-U-002 | RBAC servidor | RISK-002 | `can_access_*` / `can_edit_*` | OQ-RBAC | Reg. | Código; QO por executar |
| REQ-U-003 / REQ-F-ER-006 | Lock emitido | RISK-011 | Trigger lock + `bpx.allow_locked_update` | OQ-LOCK | Reg. | Código; QO por executar |
| REQ-U-004 | E-sign no ato | RISK-004 | `critical-esign` + RPC | OQ-ESIGN | Reg. | Código; QO por executar |
| REQ-U-005 / REQ-F-ER-004 | Audit trail old/new | RISK-010 | `bpx_audit_row_change` | OQ-TRAIL | Reg. | Código; QO por executar |
| REQ-U-006 | Contas lógicas | RISK-012 | `disableAuthUser` | OQ-ACCOUNT | Reg. | Código; QO por executar |
...
| REQ-F-ER-001 | Autorização servidor | RISK-002 | RLS papel | OQ-RBAC | Reg. | Código; QO por executar |
