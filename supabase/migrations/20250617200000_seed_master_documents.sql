...
BEGIN
  ...
  INSERT INTO public.master_documents (
    ...
    (p_tenant_id, 'RE-7.1A', 'Proposta Comercial', 'registro', 'Comercial', 'PR-7.1', '00', '2025-06-30', '2025-06-30', 'ativo', 'Código + Título + Revisão + Número, Cliente e Data', '{codigo}_{titulo}_Rev{revisao}_{numero}_{cliente}_{data}', 're-71a-proposta-comercial-pdf', 'PR-7.1'),
