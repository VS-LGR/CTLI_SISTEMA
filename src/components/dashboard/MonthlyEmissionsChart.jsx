...
const SERIES = [
  { key: "certificates", name: "Certificados Emitidos por Mês", color: "#C2410C" },
  ...
  if (!hasData) {
    return (
      <div className="h-[280px] sm:h-[320px] flex flex-col items-center justify-center text-center px-4">
        <p className="text-sm text-muted-foreground">Ainda não há emissões registadas neste ano.</p>
        <p className="text-xs text-muted-foreground mt-1">Propostas, coletas e certificados aparecerão aqui por mês.</p>
      </div>
    );
  }
