    ...
    <Card className={personnelPanelCardClass(compact)}>
      <CardContent className={compact ? "p-0 space-y-4" : "p-4 space-y-4"}>
        <div className="flex justify-end">
          <Button size="sm" className="bg-primary" onClick={() => navigate(experienceEvaluationEditorPath("nova"))}>
          ...
          <table className="w-full text-sm min-w-[900px]">
            ...
            <tbody>
              {displayRows.length === 0 && (
                <tr><td colSpan={9} className="p-4 text-center text-muted-foreground">Nenhuma avaliação.</td></tr>
              )}
              {displayRows.map((r) => (
