...
export const HERO_SHORTCUTS = [
  {
    ...
    bgClass: "bg-[#C2410C] hover:bg-[#9A3412]",
    icon: FileText,
  ...
  },
  {
    ...
    to: COLETA_HUB_PATH,
    bgClass: "bg-[#44403C] hover:bg-[#292524]",
    icon: ClipboardText,
    requiresColeta: true,
    module: "coleta",
  },
  {
    ...
    bgClass: "bg-[#9A3412] hover:bg-[#7C2D12]",
    icon: Certificate,
  ...
  },
  {
    ...
    bgClass: "bg-[#B45309] hover:bg-[#92400E]",
    icon: Certificate,
    requiresCalibrationCertificates: true,
    module: "certificados",
  },
  ...
  },
  {
    ...
    bgClass: "bg-[#57534E] hover:bg-[#44403C]",
    icon: Cube,
  ...
  },
  {
    ...
    bgClass: "bg-[#7C2D12] hover:bg-[#9A3412]",
    icon: Scales,
