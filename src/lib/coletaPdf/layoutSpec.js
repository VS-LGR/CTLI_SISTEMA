...
export const FRENTE = {
  ...
  sec1: {
    ...
    cliente: pos(5.6, 0.73, 48, 0.75),
    cnpj: pos(6.35, 0.73, 48, 0.7),
    endereco: pos(7.05, 0.73, 48, 0.7),
    responsavel: pos(7.75, 0.73, 48, 0.7),
  },
  sec2: {
    title: pos(8.7, 0.73, 22, 0.8),
    row1: pos(9.8, 2.25, 47.5, 2.0),
    row2: pos(12.0, 2.25, 47.5, 2.0),
    tipoBalanca: pos(14.5, 0.74, 48.5, 2.1),
    tipoPlataforma: pos(16.87, 0.74, 48.5, 2.1),
  },
  sec3: {
